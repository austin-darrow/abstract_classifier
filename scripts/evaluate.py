#!/usr/bin/env python
"""Evaluate classification results (works with any approach).

Usage:
    python scripts/evaluate.py
    python scripts/evaluate.py --config configs/default.yaml configs/vista.yaml
"""
...
def main():
    ...
    from cip_classifier.evaluation.metrics import run
